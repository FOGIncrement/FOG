...
export const ACTION_COST_RESOURCES = {
    ...
    buildCatechismHall: ['faithContainer', 'woodContainer'],
    buildWarCamp: ['faithContainer', 'woodContainer', 'stoneContainer'],
...
export const CARD_ACTION_COST_RESOURCES = {
    ...
    'city-dig-well-btn': ['woodContainer', 'stoneContainer'],
    'city-hold-feast-btn': ['foodContainer']
};
