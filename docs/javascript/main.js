...
const CHEAT_BALANCE_FIELD_SECTIONS = [
    {
        ...
        entries: [
            ...
            { label: 'Follower Food Use Per Second', target: game, key: 'followerFoodPerSecond', step: 0.01, min: 0 },
            { label: 'Hunger Drain Per Food Deficit', target: game, key: 'hungerDrainPerFoodDeficit', step: 0.1, min: 0 },
            ...
            { label: 'Shelter Cost Scale Per Built', target: game, key: 'shelterCostScalePerBuilt', step: 0.01, min: 0 },
    ...
    },
    {
        ...
        entries: [
            ...
            { label: 'Feed Followers Cost (Food)', target: gameState.costs, key: 'manualFeedFoodCost', step: 1, min: 0 },
...
function normalizeBalanceSettings() {
    ...
    if (game.shelterCostScalePerBuilt < 0) {
        game.shelterCostScalePerBuilt = 0;
    }
}
